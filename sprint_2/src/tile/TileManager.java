...
//
//        // Left bottom corner
//        g2.drawImage(tile[6].image, startX + gp.tileSize, startY + (gp.totalTiles - 2) * gp.tileSize, gp.tileSize, gp.tileSize, null);
//
//        // Right top corner
//        g2.drawImage(tile[2].image, startX + (gp.totalTiles - 2) * gp.tileSize, startY + gp.tileSize, gp.tileSize, gp.tileSize, null);
//
//        // Right bottom corner
